...
#My Code (to replicate the above code from scratch):
# Note: Trials have been commmented out.
city_name <- "Istanbul, Turkey"

#pop_year_one <- 691000
#pop_year_one <- 8831800
pop_year_one <- 983000
pop_year_two <- 8831800
...
annual_gr = percentage_gr / (2000 - 1950)

#print(annual_gr)

#Now to call on the function given above (lines 6 to 10) 
